<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WCFComplexClient.aspx.cs" Inherits="CallingWCFUsingAjax.WCFComplexClient" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#Button1").click(function (evt) {
                ...
                var options = {};
                options.url = "TemperatureService.svc/ConvertComplexType";
                options.type = "POST";
