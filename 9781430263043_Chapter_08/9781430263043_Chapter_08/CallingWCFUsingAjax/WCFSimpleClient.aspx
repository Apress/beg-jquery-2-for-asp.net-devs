<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WCFSimpleClient.aspx.cs" Inherits="CallingWCFUsingAjax.WCFSimpleClient" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#Button1").click(function (evt) {
                ...
                var options = {};
                options.url = "TemperatureService.svc/ConvertSimpleType";
                options.type = "POST";
