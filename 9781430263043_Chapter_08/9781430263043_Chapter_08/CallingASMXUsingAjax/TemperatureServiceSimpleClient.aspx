<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemperatureServiceSimpleClient.aspx.cs" Inherits="CallingASMXUsingAjax.TemperatureServiceSimpleClient" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#Button1").click(function (evt) {
                ...
                var options = {};
                options.url = "TemperatureService.asmx/ConvertSimpleType";
                options.type = "POST";
                ...
                options.error = function (jqXHR, status, err) {
                    alert(status);
                };
                $.ajax(options);
                evt.preventDefault();
